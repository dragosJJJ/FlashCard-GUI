#----- THE PURPOSE OF THIS APP IS TO HELP YOU LEAR THE MOST COMMONLY USED WORDS IN FRENCH.. IF YOU KNOW THE WORD AFTER CARD IS FLIPPED.. THE WORD IS REMOVED FROM THE LIST
from tkinter import *
